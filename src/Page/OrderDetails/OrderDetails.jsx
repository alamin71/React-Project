            ...
            <div className="w-full border flex flex-col md:flex-row md:items-start md:mt-4 mt-3 bg-[#D2C5A2] rounded-md p-4">
              <div className="md:text-base text-sm flex-1 font-semibold md:border-r-2 md:border-black md:pr-10">
                ...
                <div className="space-y-1 w-full">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-start">
                      {orderDetails.parentName || "N/A"}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Email:</p>
                    <p>{orderDetails.email || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>School/College:</p>
                    <p>{orderDetails.school || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Address:</p>
                    <p>{orderDetails.permanentAddress || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>NID Number:</p>
                    <p>{orderDetails.nid || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Local Guardian’s Name:</p>
                    <p>{orderDetails.guardianName || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Blood Group:</p>
                    <p className="text-start">
                      {orderDetails.bloodGroup || "N/A"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:text-base text-sm flex-1 font-semibold md:ml-10 mt-m_medium">
                ...
                <div className="space-y-1 w-full">
                  <div className="flex items-center justify-between">
                    <p>Form No:</p>
                    <p className="text-start">{orderDetails.formNo || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Parent Phone:</p>
                    <p>{orderDetails.parentNumber || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Job Information:</p>
                    <p className="text-start">
                      {orderDetails.jobInfo || "N/A"}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Gender:</p>
                    <p>{orderDetails.gender || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Permanent Address:</p>
                    <p className="text-start">
                      {orderDetails.permanentAddress || "N/A"}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Mobile No:</p>
                    <p>{orderDetails.mobile || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Date of Birth:</p>
                    <p>{orderDetails.dob || "N/A"}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Photo:</p>
                    <p>
              ...
              <table className="overflow-x-auto border w-full">
                ...
                <tbody className="md:text-base text-sm font-semibold">
                  {orderDetails.cartItems &&
                    orderDetails.cartItems.map((course, idx) => (
                      <tr key={idx}>
